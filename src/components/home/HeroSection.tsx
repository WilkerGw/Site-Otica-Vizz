...
export function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col lg:flex-row items-center justify-center min-h-screen px-4 pt-16 text-gray-100 overflow-hidden max-w-[1600px] mx-auto">
      ...
      <div className="absolute top-5 left-1/2 -translate-x-1/2 z-20 lg:top-1/2 lg:left-0 lg:-translate-y-1/2 lg:translate-x-0 flex flex-col items-center justify-center text-center w-full lg:w-[auto] lg:pl-4 lg:pt-0">
        {/* Animação de fade-in para o logo */}
        <div className="flex flex-col items-center justify-center gap-1">
          <motion.div
            className="pb-2 rounded-lg  bg-gray-950/70 backdrop-blur-[1px]"
          ...
          {/* Ícones sociais */}
          <div className="flex flex-col items-center gap-3 w-full rounded-lg bg-gray-950/70 backdrop-blur-[1px]">
            <motion.div
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 mt-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 w-full max-w-sm md:w-auto justify-center px-6 py-3 rounded-xl border-2 border-gray-500/20 text-white font-semibold shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:bg-black hover:border-gray-300 bg-gray-950/70 backdrop-blur-[1px]"
          >
          ...
          <Link
            ...
            target="_blank"
            className="flex items-center gap-4 w-full max-w-sm md:w-auto justify-center px-6 py-3 rounded-xl border-2 border-gray-500/20 text-gray-500 font-semibold shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:bg-black hover:border-gray-300 bg-gray-950/70 backdrop-blur-[1px]"
          >
      ...
      <div className="absolute bottom-0 lg:bottom-1/4 lg:-translate-y-1/4 rounded-lg  lg:right-4 w-[90%] lg:w-[30rem] h-[17rem] mb-6 lg:mb-0">
